...
bool read_fixed_array(std::ifstream &in, T (&dst)[N]) {
    float value = 0.0f;
    for (int i = 0; i < N; ++i) {
...
int main(int argc, char **argv) {
    ...
    static weight_t conv1_w[CONV1_W_COUNT] = {};
    static data_t conv1_b[C1_OUT] = {};
    static weight_t conv2_w[CONV2_W_COUNT] = {};
    static data_t conv2_b[C2_OUT] = {};
    static weight_t fc1_w[FC1_W_COUNT] = {};
    static data_t fc1_b[FC1_OUT] = {};
    static weight_t fc2_w[FC2_W_COUNT] = {};
    static data_t fc2_b[FC2_OUT] = {};
    static weight_t fc3_w[FC3_W_COUNT] = {};
