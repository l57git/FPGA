...
void lenet_accel(
    ...
    const weight_t conv1_w[lenet_cfg::CONV1_W_COUNT],
    const data_t conv1_b[lenet_cfg::C1_OUT],
    const weight_t conv2_w[lenet_cfg::CONV2_W_COUNT],
    const data_t conv2_b[lenet_cfg::C2_OUT],
    const weight_t fc1_w[lenet_cfg::FC1_W_COUNT],
    const data_t fc1_b[lenet_cfg::FC1_OUT],
    const weight_t fc2_w[lenet_cfg::FC2_W_COUNT],
    const data_t fc2_b[lenet_cfg::FC2_OUT],
    const weight_t fc3_w[lenet_cfg::FC3_W_COUNT],
